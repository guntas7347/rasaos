...
import { Mail, Lock, ArrowRight, Eye, EyeOff, UserCircle } from "lucide-react";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    const checkSession = async () => {
      const response = await callServer("/auth/me", { timeout: 1500 }, false);
          ...
          {!showNormalLogin && existingUser ? (
            <div className="text-center">
              ...
              <button
                ...
                className="w-full flex items-center justify-center py-3.5 px-4 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition-all duration-200 active:scale-[0.98] mb-4"
              >
              ...
              <button
                onClick={() => setShowNormalLogin(true)}
            ...
            <>
              ...
              {existingUser && (
                <button
                  onClick={() => setShowNormalLogin(false)}
                  className="w-full mt-4 text-sm font-medium text-blue-600 dark:text-blue-400 hover:underline"
                >
