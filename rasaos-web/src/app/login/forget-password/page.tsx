        ...
        <div className="bg-white/80 dark:bg-neutral-950/80 backdrop-blur-xl rounded-3xl shadow-xl dark:shadow-2xl dark:shadow-blue-900/10 border border-white/20 dark:border-neutral-800/50 p-8 sm:p-10 transition-all duration-300 hover:shadow-2xl">
          <div className="mb-10 text-center">
            ...
            <p className="mt-3 text-neutral-500 dark:text-neutral-400 text-sm">
              We'll send you a secure link to securely reset your password.
            </p>
          </div>

          {isSuccess ? (
            <div className="text-center space-y-6 text-sm">
              <div className="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300 p-4 rounded-xl border border-blue-200 dark:border-blue-800/50">
                A password reset link has been sent to <strong>{email}</strong>.
              </div>
              <Link
                to="/login"
                className="inline-block px-4 py-2 font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
              >
                Return to Login
              </Link>
            </div>
